...
const CartPage = () => {
  ...
  return (
    <div className="p-6 md:p-12">
      <h2 className="text-5xl p-8 mt-10 font-semibold w-full text-center">
        ...
        <div className="flex-1">
          {cart.length === 0 ? (
            ...
            cart.map((item) => (
              <div
                key={item.id}
                className="flex items-center justify-between p-8 bg-white border border-gray-200 shadow-sm rounded-lg mb-5"
              >
